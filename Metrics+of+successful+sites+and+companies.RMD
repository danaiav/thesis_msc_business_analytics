...
total_500 <- read.csv("F:/Dropbox/Dani/Spinellis - Diplwmatiki/Jupyter markdown/total_500_nanull.csv", sep=";")
...
num <- c(2,3,4,5,6,9,13,14,12,24,25,757,758,759,760,761,762,763,764,765,766,767)
for(i in 1:22){
  k <- num[i]
  total_500.sub[,k] <- as.numeric(as.character(total_500.sub[,k]))}  
total_500.sub[10:11] <- lapply(total_500.sub[10:11], as.numeric)
total_500.sub[15] <- lapply(total_500.sub[15], as.numeric)
str(total_500.sub[757:766])
...
plot(images)
########################################################################################################
b <- ggplot(total_500.sub$images,aes(total_500.sub$company)) 
#change factor to logical or boolean 1 - 0
