...
library(ggplot2)
ggplot(data=total_500_final,aes(x=external))+geom_histogram()
ggplot(data=total_500_final,aes(x=internal))+geom_histogram()
ggplot(data=total_500_final,aes(x=total.links))+geom_histogram()
#########################################################################################################
