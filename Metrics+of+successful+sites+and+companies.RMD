...
names(total_500)
str(total_500)
#First of all we have to delete the naming of the nas prices so as for r to rgognise them
total_500.sub <- total_500
for(k in 1:767){
total_500.sub[,k]  <- as.character(total_500.sub[,k])
total_500.sub[,k][total_500.sub[,k] == "n/a"] <- ""
total_500.sub[,k] <- as.factor(total_500.sub[,k])}
...
library(ggplot2)
ggplot(data=total_500.sub,aes(x=external))+geom_histogram()
ggplot(data=total_500.sub,aes(x=internal))+geom_histogram()
ggplot(data=total_500.sub,aes(x=total.links))+geom_histogram()
#########################################################################################################
#Now we will see the loading time per site
ggplot(data=total_500.sub,aes(x=loading.time))+geom_histogram()
#########################################################################################################
#Now we will see the words in total and fo unique count
ggplot(data=total_500.sub,aes(x=total_words))+geom_histogram()
ggplot(data=total_500.sub,aes(x=unique_words))+geom_histogram()
#########################################################################################################
...
#########################################################################################################
ggplot(data=total_500.sub,aes(x=total.images))+geom_histogram()
ggplot(data=total_500.sub,aes(x=.tif))+geom_histogram()
ggplot(data=total_500.sub,aes(x=.bmp))+geom_histogram()
ggplot(data=total_500.sub,aes(x=.tiff))+geom_histogram()
