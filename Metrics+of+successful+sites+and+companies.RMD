...
par(mfrow=c(3,3))
k = c(756,757,758,759,760,761,762,763,764)
for(i in 1:9){
  a <- k[i]
...
##########################################################################################################
ggplot(data=total_500_final,aes(x=Assets..))+geom_histogram()
ggplot(data=total_500_final,aes(x=Market.value..))+geom_histogram()
ggplot(data=total_500_final,aes(x=Revenues..))+geom_histogram()
ggplot(data=total_500_final,aes(x=Total.Stockholder.Equity..))+geom_histogram()
