...
total_500_final$Revenues <- NULL #WE SUBSTRACT IT AS WE SAID IN THE BEGGINING
...
2
3
#Based on those results we will try to cluster the companies based on the results of the regrssion
...
#More over the total images have a very high price that makes the clustering seperations a little f=different than the seperation we have made with the top 10. So if we make 3 clusters we can see that we have also a similar seperation as the one we have.
######################################################################################################
```
