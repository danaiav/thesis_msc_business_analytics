...
Companies are obliged by the trends to be active on-line and to maintain a website that depicts the image they want their consumers to perceive. By creating a more consumer oriented website they lead the users to create a positive idea regarding the company and this could potentially lead to bigger sales.\\
The purpose of this paper is to understand the relationship that exists between a company's' website and the overall company's success. A measure that can be comparable between enterprises are the company's' revenues. Trying to comprehend this relationship a comparison will take place between the enterprises that were deemed as the more successful ones from Fortune 500 (based on their revenues) and a number of website metrics in order to understand through the performance of statistical analysis which metrics affect the most a company's success.
\newpage
\section{Literature Review }
The World Wide Web was created and developed in the United States of America and initially it was used from the government and educational and non commercial research institutions only. The first commercial use of the Web was not until 1993.\cite{key1} From then on the Web had an explosive growth that led to the existence of more than 200 million sites by 2005.\cite{key3} By now this number has been increased even more and it keeps growing daily. Taking into account this fact the research around the impact of the web pages into an organisation success is undoubtedly an interesting topic for examination.
\subsection{Empirical Studies}
Until now many studies have been conducted in the attempt to provide information regarding a vast number of different aspects of the Web and the trends that exist on it regarding the commercial behaviour of the users.\\
Many researchers thought that the internet and more specifically the Web is the best platform to attract more visitors and to reach new clients.\cite{key4} Based on this idea there has been many studies that have examined the best way to create websites based on a consumer friendly design in order to add value to the users. Since a user interface that is perceived as very good is a vital factor in the retention rate of the visitors\cite{key6} there has been many studies that investigate what constitutes an excellent interface.Wei-Shang Fan and Ming-Chun Tsai\cite{key5} in 2010 studied the relation between the internet customisation with the web design and the internet marketing strategy. This research showed that organisations should engage in internet customization planning and create their internet marketing strategies with the goal to attract consumers to browse and even purchase products from their websites. In order to make the operations of the website successful and appealing to consumers they should provide product information and offer them services that will cover their needs, as a result they should focus on the websites overall design.\\
Nevertheless even though there are previous studies that have investigates the critical success factors of a website overall design, most of those findings were derived from questionnaires that were implemented on internet users or even web designers. A content analysis of a website features was conducted in 1997\cite{key7} where the authors examined the companies of the Fortune 500 to see how many of those had web sites, in which industries did they belong, whether or not where there any differences in the revenues regarding the existence of a site and content of the pages. The findings of this research showed that even in 1997 the two thirds of the companies in the list had already set up their web pages regardless their industries. This findings shows a high correlation of successful companies with the use of web sites as a mean to reach potential customers.\\
Moreover in 2006 there has been a study that compared the use of websites in the top 1000 successful companies between two different countries\cite{key2} Us and Taiwan in order to understand the diversities in the web practices. The results showed that the countries are in different stages regarding the maturity of the internet usage for consumer attraction.\\
Regarding the web sitee


 
\subsection{Thesis hypothesis}
This study extends beyond previous studies by devoting most effort on examining specific web site metrics that were deemed important from previous studies that were based on the perceptions of web users in relation only to the revenues of a company regardless any other information for the enterprise.\\
The questions of the research were the following:
\begin{enumerate}
\item Does revenues of companies relate to the presence of the website?
...
\begin{center}
\includegraphics[scale=0.5]{../R/photos/91_clust_ld.png}   \\
\end{center}
\end{table}
...
\begin{center}
\includegraphics[scale=0.5]{../R/photos/96_clust_60.png}   \\
\end{center}
\end{table}
...
\begin{center}
\includegraphics[scale=0.5]{../R/photos/99_clust_24px.png}   \\
\end{center}
\end{table}
...
\pagebreak  
\section{Conclusions}
With the completion of the analysis of the variables that we gathered from the python scripts, that were created in order to download the needed information from the html code behind the home pages of the companies, that were ranked as the 500 most successful ones from the Fortune 500, we can reach to the conclusion that the most important indicators that can be related to the actual success of a company are the following ones:
\begin{itemize}
...
Search engines like Google use page loading time in algorithms that determine search engine rankings, meaning that they are more likely to guide users to sites that load quickly. This can explain the importance of the loading time on a company's status. 
\item  \textbf{How easily comprehensible is the text on the site:} \\
While a website’s visual design is how a company looks online, the site’s writing is how it sounds online. Tone of voice and great content are crucial for communicating on the Internet. Nevertheless, the best copywriting is for nothing if users don’t read the text. As with other areas of user experience, content has to survive a cost–benefit analysis on the part of users:
...
For online copy, the barriers to use fall into 3 categories: legibility, readability, and comprehension, each of which is defined and discussed below.
...
\bibitem{A1}$https://en.wikipedia.org/wiki/Fortune_500$
\bibitem{A2}$http://beta.fortune.com/fortune500$
\bibitem{A3}$http://www.tablesgenerator.com/$
\bibitem{A4}$https://www.continuum.io/downloads$
\bibitem{A5}$https://validator.w3.org/$
\end{thebibliography}
...
\subsection{Appendix C: R Scripts} \label{appP}
