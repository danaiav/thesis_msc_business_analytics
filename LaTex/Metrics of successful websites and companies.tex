...
\begin{center}
\includegraphics[scale=0.3]{../R/photos/06_rank_mark_val.png}   \\
...
\begin{center}
\includegraphics[scale=0.3]{../R/photos/07_rank_sh_eq.png}  \\
...
\subsection{Regression models}\label{r: van: rg}
\begin{lstlisting}[language=R]
```{r}
...
\subsection{Comparisons and other methods}\label{r: van: cm}
\begin{lstlisting}[language=R]
#Clustering
