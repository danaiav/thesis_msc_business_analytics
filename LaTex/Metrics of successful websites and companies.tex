...
There has been many researches regarding the impact of key performance indicators on a website. Usually the papers examine how specific measurements can explain the users behavoiur in order to try to offer them a better user experience. Those type of researches usually use some analytics tools like google analytics
\newpage
