...
In this chapter we will perform some regression models to the chosen data frame in order to determine the variables that effect most the price of the revenues of a company.The code that was created for the regression models is available in the Appendix\ref{r: van: rg}.\\
...
\begin{center}
\includegraphics[scale=0.4]{../R/photos/91_clust_ld.png}   \\
\end{center}
\end{table}
...
\begin{center}
\includegraphics[scale=0.4]{../R/photos/92_clust_read.png}   \\
\end{center}
\end{table}
...
\begin{center}
\includegraphics[scale=0.4]{../R/photos/93_clust_inst.png}   \\
\end{center}
\end{table}
...
\begin{center}
\includegraphics[scale=0.4]{../R/photos/94_clust_bmp.png}   \\
\end{center}
\end{table}
...
\begin{center}
\includegraphics[scale=0.4]{../R/photos/95_clust_jpe.png}   \\
\end{center}
\end{table}
...
\bibitem{key40}Tables Generator (2017). Retrieved January 29, 2017, from $http://www.tablesgenerator.com/$

\bibitem{key41}Continuum (2017). Retrieved January 29, 2017, from $https://www.continuum.io/downloads$

\bibitem{key42}Validator W3 (2017). Retrieved January 29, 2017, from $https://validator.w3.org/$
...
```{r}
ggplot(total_500_final_reg, aes(Revenues, X24pxx133px, color = fortuneCluster$cluster)) + geom_point(size=3)
```
