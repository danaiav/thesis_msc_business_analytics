...
full_2 <- lm(Revenues~. - total.images - total.links ,data=total_500_final_train)
summary(full_2)
x <- model.matrix(full_2) [,-c(18,28)]
dim(x)
lasso <- glmnet (x, total_500_final_train$Revenues)
par(mfrow=c(1,1),no.readonly = TRUE)
```
...
full_3 <- lm(Revenues~ im_s_small + im_s_thumbnail ,data=total_500_final_train)
summary(full_3)
