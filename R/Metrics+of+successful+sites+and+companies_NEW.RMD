...
```{r}
total_500_final$Readability <- gsub("Very easy", "1", total_500_final$Readability )
total_500_final$Readability <- gsub("Easy", "2", total_500_final$Readability )
total_500_final$Readability <- gsub("Fairly easy", "3", total_500_final$Readability )
total_500_final$Readability <- gsub("Standard", "4", total_500_final$Readability )
total_500_final$Readability <- gsub("Fairly difficult", "5", total_500_final$Readability )
total_500_final$Readability <- gsub("Difficult", "6", total_500_final$Readability )
total_500_final$Readability <- gsub("Very Confusing", "7", total_500_final$Readability )
...
```{r}
#It is obvious that the most common images type are .jpg and .png
#We will check those 2 in relationship with the revenues
